...
//            String configurationPath=args[0];
            String configurationPath="./example_input_4/configuration_file.json";
...
//            JsonObject rootObject = FileReaderUtil.readJson(configurationPath);
            JsonObject rootObject = FileHandelUtil.readJsonObject("./example_input_4/configuration_file.json");
